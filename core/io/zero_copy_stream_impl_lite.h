...
class LazyStringOutputStream : public StringOutputStream {
 ...
 private:
  const std::unique_ptr<ResultCallback<string*> > callback_;
  bool string_is_set_;
...
class CopyingInputStreamAdaptor : public ZeroCopyInputStream {
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(CopyingInputStreamAdaptor);
};
...
class CopyingOutputStreamAdaptor : public ZeroCopyOutputStream {
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(CopyingOutputStreamAdaptor);
};
