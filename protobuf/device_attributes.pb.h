...
class DeviceAttributes : public ::google::protobuf::Message {
 public:
  ...
  ::mr::BusAdjacency bus_adjacency() const;
  void set_bus_adjacency(::mr::BusAdjacency value);
  ...
  // @@protoc_insertion_point(class_scope:mr.DeviceAttributes)
 private:
  ...
  friend void  protobuf_AddDesc_device_5fattributes_2eproto();
  friend void protobuf_AssignDesc_device_5fattributes_2eproto();
  friend void protobuf_ShutdownFile_device_5fattributes_2eproto();
...
inline ::mr::BusAdjacency DeviceAttributes::bus_adjacency() const {
  // @@protoc_insertion_point(field_get:mr.DeviceAttributes.bus_adjacency)
  return static_cast< ::mr::BusAdjacency >(bus_adjacency_);
}
inline void DeviceAttributes::set_bus_adjacency(::mr::BusAdjacency value) {
...
template <> struct is_proto_enum< ::mr::BusAdjacency> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::mr::BusAdjacency>() {
  return ::mr::BusAdjacency_descriptor();
}
