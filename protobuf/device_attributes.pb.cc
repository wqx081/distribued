...
void protobuf_AssignDesc_device_5fattributes_2eproto() {
  protobuf_AddDesc_device_5fattributes_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_device_5fattributes_2eproto);
}
...
void protobuf_ShutdownFile_device_5fattributes_2eproto() {
  delete DeviceAttributes::default_instance_;
  delete DeviceAttributes_reflection_;
}

void protobuf_AddDesc_device_5fattributes_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\027device_attributes.proto\022\002mr\"\247\001\n\020Device"
    "Attributes\022\014\n\004name\030\001 \001(\t\022\023\n\013device_type\030"
    "\002 \001(\t\022\024\n\014memory_limit\030\004 \001(\003\022\'\n\rbus_adjac"
    "ency\030\005 \001(\0162\020.mr.BusAdjacency\022\023\n\013incarnat"
    "ion\030\006 \001(\006\022\034\n\024physical_device_desc\030\007 \001(\t*"
    "J\n\014BusAdjacency\022\t\n\005BUS_0\020\000\022\t\n\005BUS_1\020\001\022\013\n"
    "\007BUS_ANY\020\002\022\027\n\023BUS_NUM_ADJACENCIES\020\003b\006pro"
    "to3", 283);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_device_5fattributes_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_device_5fattributes_2eproto {
  StaticDescriptorInitializer_device_5fattributes_2eproto() {
    protobuf_AddDesc_device_5fattributes_2eproto();
  }
} static_descriptor_initializer_device_5fattributes_2eproto_;
...
DeviceAttributes::DeviceAttributes()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:mr.DeviceAttributes)
}
...
DeviceAttributes::DeviceAttributes(const DeviceAttributes& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:mr.DeviceAttributes)
}
...
DeviceAttributes::~DeviceAttributes() {
  // @@protoc_insertion_point(destructor:mr.DeviceAttributes)
  SharedDtor();
}
...
const DeviceAttributes& DeviceAttributes::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_device_5fattributes_2eproto();
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:mr.DeviceAttributes)
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
        ...
        if (tag == 18) {
         parse_device_type:
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "mr.DeviceAttributes.device_type"));
        } else {
          goto handle_unusual;
        }
      ...
      // optional .mr.BusAdjacency bus_adjacency = 5;
      case 5: {
        if (tag == 40) {
         parse_bus_adjacency:
          int value;
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          set_bus_adjacency(static_cast< ::mr::BusAdjacency >(value));
        } else {
          goto handle_unusual;
        }
        ...
        if (tag == 58) {
         parse_physical_device_desc:
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "mr.DeviceAttributes.physical_device_desc"));
        } else {
          goto handle_unusual;
        }
...
success:
  // @@protoc_insertion_point(parse_success:mr.DeviceAttributes)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:mr.DeviceAttributes)
  return false;
#undef DO_
}
...
void DeviceAttributes::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:mr.DeviceAttributes)
  // optional string name = 1;
  if (this->name().size() > 0) {
  ...
  // @@protoc_insertion_point(serialize_end:mr.DeviceAttributes)
}

::google::protobuf::uint8* DeviceAttributes::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:mr.DeviceAttributes)
  // optional string name = 1;
  if (this->name().size() > 0) {
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
      this->name().data(), this->name().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:mr.DeviceAttributes)
  return target;
}
...
void DeviceAttributes::clear_name() {
 ...
 const ::std::string& DeviceAttributes::name() const {
  // @@protoc_insertion_point(field_get:mr.DeviceAttributes.name)
  return name_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 void DeviceAttributes::set_name(const ::std::string& value) {
  
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:mr.DeviceAttributes.name)
}
 void DeviceAttributes::set_name(const char* value) {
  
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:mr.DeviceAttributes.name)
}
 void DeviceAttributes::set_name(const char* value, size_t size) {
  
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:mr.DeviceAttributes.name)
}
 ::std::string* DeviceAttributes::mutable_name() {
  
  // @@protoc_insertion_point(field_mutable:mr.DeviceAttributes.name)
 ...
 void DeviceAttributes::set_allocated_name(::std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:mr.DeviceAttributes.name)
}
...
void DeviceAttributes::clear_device_type() {
 ...
 const ::std::string& DeviceAttributes::device_type() const {
  // @@protoc_insertion_point(field_get:mr.DeviceAttributes.device_type)
 ...
 void DeviceAttributes::set_device_type(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:mr.DeviceAttributes.device_type)
}
 void DeviceAttributes::set_device_type(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:mr.DeviceAttributes.device_type)
}
 void DeviceAttributes::set_device_type(const char* value, size_t size) {
  ...
  device_type_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:mr.DeviceAttributes.device_type)
}
 ::std::string* DeviceAttributes::mutable_device_type() {
  
  // @@protoc_insertion_point(field_mutable:mr.DeviceAttributes.device_type)
 ...
 void DeviceAttributes::set_allocated_device_type(::std::string* device_type) {
  ...
  // @@protoc_insertion_point(field_set_allocated:mr.DeviceAttributes.device_type)
}
...
void DeviceAttributes::clear_memory_limit() {
 ...
 ::google::protobuf::int64 DeviceAttributes::memory_limit() const {
  // @@protoc_insertion_point(field_get:mr.DeviceAttributes.memory_limit)
  return memory_limit_;
}
 void DeviceAttributes::set_memory_limit(::google::protobuf::int64 value) {
  
  memory_limit_ = value;
  // @@protoc_insertion_point(field_set:mr.DeviceAttributes.memory_limit)
}
...
void DeviceAttributes::clear_bus_adjacency() {
 ...
 ::mr::BusAdjacency DeviceAttributes::bus_adjacency() const {
  // @@protoc_insertion_point(field_get:mr.DeviceAttributes.bus_adjacency)
  return static_cast< ::mr::BusAdjacency >(bus_adjacency_);
}
 void DeviceAttributes::set_bus_adjacency(::mr::BusAdjacency value) {
  
  bus_adjacency_ = value;
  // @@protoc_insertion_point(field_set:mr.DeviceAttributes.bus_adjacency)
}
...
void DeviceAttributes::clear_incarnation() {
 ...
 ::google::protobuf::uint64 DeviceAttributes::incarnation() const {
  // @@protoc_insertion_point(field_get:mr.DeviceAttributes.incarnation)
  return incarnation_;
}
 void DeviceAttributes::set_incarnation(::google::protobuf::uint64 value) {
  
  incarnation_ = value;
  // @@protoc_insertion_point(field_set:mr.DeviceAttributes.incarnation)
}
...
void DeviceAttributes::clear_physical_device_desc() {
 ...
 const ::std::string& DeviceAttributes::physical_device_desc() const {
  // @@protoc_insertion_point(field_get:mr.DeviceAttributes.physical_device_desc)
 ...
 void DeviceAttributes::set_physical_device_desc(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:mr.DeviceAttributes.physical_device_desc)
}
 void DeviceAttributes::set_physical_device_desc(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:mr.DeviceAttributes.physical_device_desc)
}
 void DeviceAttributes::set_physical_device_desc(const char* value, size_t size) {
  ...
  physical_device_desc_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:mr.DeviceAttributes.physical_device_desc)
}
 ::std::string* DeviceAttributes::mutable_physical_device_desc() {
  
  // @@protoc_insertion_point(field_mutable:mr.DeviceAttributes.physical_device_desc)
 ...
 void DeviceAttributes::set_allocated_physical_device_desc(::std::string* physical_device_desc) {
  ...
  // @@protoc_insertion_point(field_set_allocated:mr.DeviceAttributes.physical_device_desc)
}
