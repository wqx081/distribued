...
#ifndef PROTOBUF_mr_5fserver_2eproto__INCLUDED
#define PROTOBUF_mr_5fserver_2eproto__INCLUDED
...
class JobDef : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:mr.JobDef)
 private:
  ...
  friend void  protobuf_AddDesc_mr_5fserver_2eproto();
  friend void protobuf_AssignDesc_mr_5fserver_2eproto();
  friend void protobuf_ShutdownFile_mr_5fserver_2eproto();
...
class ClusterDef : public ::google::protobuf::Message {
 public:
  ...
  const ::mr::JobDef& job(int index) const;
  ::mr::JobDef* mutable_job(int index);
  ::mr::JobDef* add_job();
  ...
  // @@protoc_insertion_point(class_scope:mr.ClusterDef)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  bool _is_default_instance_;
  ::google::protobuf::RepeatedPtrField< ::mr::JobDef > job_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_mr_5fserver_2eproto();
  friend void protobuf_AssignDesc_mr_5fserver_2eproto();
  friend void protobuf_ShutdownFile_mr_5fserver_2eproto();
...
class ServerDef : public ::google::protobuf::Message {
 public:
  ...
  const ::mr::ClusterDef& cluster() const;
  ::mr::ClusterDef* mutable_cluster();
  ::mr::ClusterDef* release_cluster();
  void set_allocated_cluster(::mr::ClusterDef* cluster);
  ...
  const ::std::string& default_session_config() const;
  void set_default_session_config(const ::std::string& value);
  void set_default_session_config(const char* value);
  void set_default_session_config(const char* value, size_t size);
  ::std::string* mutable_default_session_config();
  ::std::string* release_default_session_config();
  void set_allocated_default_session_config(::std::string* default_session_config);
  ...
  // @@protoc_insertion_point(class_scope:mr.ServerDef)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  bool _is_default_instance_;
  ::mr::ClusterDef* cluster_;
  ::google::protobuf::internal::ArenaStringPtr job_name_;
  ::google::protobuf::internal::ArenaStringPtr default_session_config_;
...
inline ::mr::ClusterDef* ServerDef::release_cluster() {
  
  ::mr::ClusterDef* temp = cluster_;
  cluster_ = NULL;
  return temp;
}
inline void ServerDef::set_allocated_cluster(::mr::ClusterDef* cluster) {
  delete cluster_;
  cluster_ = cluster;
  if (cluster) {
...
inline const ::std::string& ServerDef::default_session_config() const {
...
inline void ServerDef::set_default_session_config(const ::std::string& value) {
...
inline void ServerDef::set_default_session_config(const char* value) {
...
inline void ServerDef::set_default_session_config(const char* value, size_t size) {
...
inline ::std::string* ServerDef::mutable_default_session_config() {
...
inline ::std::string* ServerDef::release_default_session_config() {
  
  return default_session_config_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void ServerDef::set_allocated_default_session_config(::std::string* default_session_config) {
...
#endif  // PROTOBUF_mr_5fserver_2eproto__INCLUDED
